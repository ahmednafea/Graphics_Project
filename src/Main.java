...
public class Main {
    public static void main(String[] args) {
       ...
       // TexturedModel tree1 = new TexturedModel(OBJLoader.loadObjModel("tree", loader),new ModelTexture(loader.loadTexture("tree")));
        ...
        Terrain terrain =new Terrain(0,-1,loader,texturePack,blendMap,"hieghtmap");
        Terrain terrain1 =new Terrain(-1,-1,loader,texturePack,blendMap,"hieghtmap");
        ...
        for(int i=0;i<400;i++){
            ...
            y=terrain.getHieghtofTerrain(x,z);
            entities.add(new Entity(grass, new Vector3f(x, y,z), 0, random.nextFloat()*360, 0,random.nextFloat()*0.1f+0.8f));
            }
            if(i%4==0) {
                float x,y,z;
                x=random.nextFloat() * 800 - 400;
